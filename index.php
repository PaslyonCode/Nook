...
$user = current_user();
$assetVersion = '20260902_editorjs_1';
...
<head>
  ...
  <link rel="stylesheet" href="assets/editorjs-full-tools.css?v=<?= h($assetVersion) ?>">

<script>window.NOOK_ASSET_VERSION=<?= json_encode($assetVersion) ?>;</script>
  <?php if ($user): ?>
  <script src="assets/vendor/editorjs/editorjs.umd.js?v=<?= h($assetVersion) ?>"></script>
  <script src="assets/vendor/editorjs/image.umd.js?v=<?= h($assetVersion) ?>"></script>
  <script src="assets/editorjs-full-tools.js?v=<?= h($assetVersion) ?>"></script>
  <?php endif; ?>
